    ...
    <body id="normalbody">
        ...
        <div id="page_wrapper">
            <div id="main" >
                ...
                <!--<div class="bodyText articleText" style="height:900px;background-color:#CAC3AC !important;" >-->
                <!--<div class="bodyText articleText" style="height:900px;background-color:#C9B77E !important;">-->
                <!--<div class="bodyText articleText" style="height:900px;background-color:#FFD900 !important;">-->
                <!--<div class="bodyText articleText" style="height:900px;background-color:#E6C300 !important;">-->
                <div class="bodyText articleText" style="height:900px;background-color:#CCAD00 !important;">
                    ...
                    <div style="opacity:1.0" class="homeTableContainer">
                        ...
                        <div class="nestedText" style="width:597!important;background-color:transparent!important;">
                            ...
                            <div style="margin-left:30px;">
                                ...
                                <img src="/images/truck_full_view.jpg" alt="trucks picture" style="margin-top:20px;float:left;margin-right: 10px;"/>
                        ...
                        <div class="quickLinkSection quickLinkSection_gold" style="float:right;margin-right:20px;border: 3px solid #969696;margin-top:30px !important;">
                            <div class="quickLinkHead quickLinkHead_darkgold">Congratulations</div>
                        ...
                        <div class="quickLinkSection quickLinkSection_red" style="float:right;margin-right:20px;border: 3px solid #969696;margin-top:10px !important;">
                            <div class="quickLinkHead quickLinkHead_darkred">News Highlights</div>
                        ...
                        <div class="quickLinkSection" style="float:right;margin-right:20px;border: 3px solid #969696;margin-top:10px !important;">
                            <div class="quickLinkHead">Drivers</div>
                            <p><a href="https://www.blackhorsecarriers.com/application.php" style="font-style: Georgia;font-size:12pt;">Drivers Apply Here</a></p>

                        </div>

                        <div class="quickLinkSection quickLinkSection_yellow" style="float:right;margin-right:20px;border: 3px solid #969696;margin-top:10px !important;">
                            <div class="quickLinkHead quickLinkHead_darkyellow">Employee Links</div>
                        ...
                        <div class="quickLinkSection quickLinkSection_red" style="float:right;margin-right:20px;border: 3px solid #969696;margin-top:10px !important;">
                            <div class="quickLinkHead quickLinkHead_darkred">Customer Links</div>
