	...
	background: #ffffff;
		...
		<div id="page_wrapper">
			<div id="main" >
				...
				<div class="bodyText articleText" style="height:700px;background-image: url(images/full_group_rotated.png);background-position: 150% 150%;" >
					<div class="homeTableContainer" style="background-image:url(images/white50pct.png)">
						<div class="nestedText" style="width:597px!important;background-color:transparent !important;">
						...
						are achieved.</p>
								...
								<p style="float:left;">Organizing and operating efficient transportation
								and distribution
								systems with effective fleet sizing, routing and
								scheduling, plus
						...
						<div class="quickLinkSection" style="float:right;margin-right:20px;border: 3px solid #7DA87D;margin-top:40px !important;">
							...
							<div class="quickLinkSectionImage">
   							...
   							<p><a href="http://www.blackhorsecarriers.com/community/phpbb3/">Resolution&nbsp;&&nbsp;Service&nbsp;Center&nbsp;</a></p>
                            ...
                            <div style=""><a href="illinoislocations.php?site=9120+W.+191st+Street,Mokena,Il+60448&locname=Mokena">Mokena, IL - NOW OPEN!</a></div>
                            <div style="font-size:8pt;margin-left:10px;">Shared Services, Crossdock, Warehouse</div>  
							<!--<p><a href="/jacksonvillenews.php">Jacksonville Startup!</a></p>-->
