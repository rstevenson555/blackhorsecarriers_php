	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function () {
                ...
                //$('#animatetag').click(function() {
                //    $(this).animate({backgroundPosition: '0px 0px'}) 
                //})
                //$('#animatetag').animate({backgroundPosition:'500px 150px'},"slow");
                /$('#animatetag').animate({backgroundPosition:'-220px 0px'},"slow");
                //$('#animatetag').animate({backgroundPosition:'0px 0px'},"slow");
                 //$("#animatetag").animate({
                 //     "opacity": "hide"
                 //   }, "slow", "easein");
    ...
    background-image: url(images/background.jpg);
		...
		<div id="page_wrapper">
			<div id="main" >
				...
				<div id="animatetag" class="bodyText articleText" style="height:600px;" >
					<div class="homeTableContainer">
						<div class="nestedText" style="background-color:transparent !important;">
						...
						<div class="quickLinkSection" style="border: 3px solid #7DA87D;margin-top:40px !important;">
							...
							<div class="emplinks">
								<div><a href="https://ipay.adp.com">Payroll Statements</a></div>
								<div><a href="https://home.eease.adp.com">Benefits</a></div>
							</div></p>
							<p><a href="/jacksonvillenews.php">Jacksonville Startup!</a></p>
							<p><a href="/presidentaward2009.php">2009 Presidents Award</a></p>
						</div>
