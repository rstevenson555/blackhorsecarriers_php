...
<html>
    <head>
        ...
        <title>Fort Worth TX startup!</title>
					...
					<table style="margin-top:10px;width:100%">
						<tbody>
							<tr >
								<td align="center">
									<p style=""><h1>
                                    Fort Worth, Texas drivers, dock and start-up team for new Automotive Parts operation.<br/>
                                    Operation start-up June 1, 2012.</h1>
						...
						<tbody>
							<tr>
								<td colspan="2" align="center">
									<img border="1" src="images/fort_worth_large.jpg"/>
								</td>
							</tr>
						</tbody>
					</table>

                    <p>From Left to right…  Jim Isaacson, Jason Martinez, Haddjj Lowe, Shawn Banda, Troy Taylor, Marvin George, Pat Gaston, 
                        John Previti, John Brown, Dave Eckert, Barry Stowers, Suzzette Schroeder, Steve O'Donnell, Mike Hade, Thomas Schonauer, 
                        John Garretson and Gerry Niedert

                        <br/>Not pictured - Relay Drivers - Billy Adams, William Burke, Patrick Diaz, Keith Downer, Don Henry, and Troy Taylor.
