...
if ($_SERVER["HTTP_HOST"] == "blackhorsecarriers.com") {
    ...
    Header("Location: http://www.blackhorsecarriers.com/index-video.php");
}
?>
                    ...
                    <div class="homeTableContainer">
                        <div class="nestedText" style="width:597!important;background-color:transparent !important;">
                            ...
                            <div>
                                ...
                                <p style="float:left;">"Organizing and <span class="double_underline"><img src="/images/film.gif"/><a overlayShow="true" frameWidth="640"
                                                                                                                                               frameHeight="360" rel="fancyvideo" href="http://www.youtube.com/watch?v=lNuNMGUj0dc">operating efficient transportation and distribution
